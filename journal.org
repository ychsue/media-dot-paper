...
2. You should set some default values in ~android.json~, ~ios.json~, ~osx.json~, etc. and those values will change your platfroms' setting files such as ~Info.plist~ file everytime you run ~cordova prepare ....~.
