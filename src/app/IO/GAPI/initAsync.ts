...
import { IuserProfile, userProfile$, userProfile$next } from "./User/userProfile$";
...
export default async function initAsync() {
    ...
    await gapi.client.init({
        ...
        clientId: '115030163273-efrl7g36idmhal48lm6svgr344ur2ogl.apps.googleusercontent.com',
        discoveryDocs: [
