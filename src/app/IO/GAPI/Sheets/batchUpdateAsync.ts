...
export default async function batchUpdateAsync({scopes, ...props}:IOProps) {
    const res = await withMustSignIn((!!scopes)?scopes:'https://www.googleapis.com/auth/spreadsheets')(batchUpdateGAPIAsync)(props);
