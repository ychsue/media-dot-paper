        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 17:
                        if (!(cordova.platformId === 'ios')) return [3 /*break*/, 28];
                    ...
                    case 20:
                        ...
                        _a.label = 21;
                    case 21:
                        if (!isSaved) return [3 /*break*/, 28];
                        action = new Promise(function (res, rej) {
                            window.plugins.socialsharing.available(function (b) { return res(b); });
                        });
                        return [4 /*yield*/, action];
                    case 22:
                        if (!((_a.sent()) === false)) return [3 /*break*/, 23];
                    ...
                    case 23:
                        action = new Promise(function (res, rej) {
                            ...
                            cordova.plugins['fileOpener2'].showOpenWithDialog(fileEntry_1.toURL(), 'text/plain', { error: rej, success: res });
                        });
