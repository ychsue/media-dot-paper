...
var DraglistComponent = /** @class */ (function () {
    ...
    DraglistComponent.prototype.ngOnInit = function () {
        ...
        self._subSwap = self.contentPointerdown$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (_) { return self.deviceService.onPointermove$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["takeUntil"])(self.deviceService.onPointerup$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["merge"])(self.deviceService.onPointermove$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["first"])(), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["delay"])(1000))))), 
        // takeUntil(self.deviceService.onPointermove$.pipe(
        //   debounceTime(400),
        //   merge(self.deviceService.onPointerup$)
        // )),
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["concat"])(Object(_node_modules_rxjs__WEBPACK_IMPORTED_MODULE_1__["of"])({ timeStamp: 0, movementX: 0, screenX: -Infinity, screenY: -Infinity }))); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["concatAll"])(), 
        // map(ev => ev.clientX)
...
var MeMainDashboardComponent = /** @class */ (function () {
    function MeMainDashboardComponent(meService, msg, nZone) {
        this.meService = meService;
        this.msg = msg;
        this.nZone = nZone;
    ...
    MeMainDashboardComponent.prototype.onChangeCurrentTime = function (ev, evOf) {
        return __awaiter(this, void 0, void 0, function () {
            var self, state, target, rect, layerX;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        self = this;
                        state = this.meService.state;
                        console.log(state);
                        return [4 /*yield*/, self.meService.canGetCurrentTime$$()];
                    case 1:
                        if ((_a.sent()) === false) {
    ...
    MeMainDashboardComponent = __decorate([
        ...
        __metadata("design:paramtypes", [src_app_services_media_edit_service__WEBPACK_IMPORTED_MODULE_1__["MediaEditService"], _services_message_service__WEBPACK_IMPORTED_MODULE_2__["MessageService"],
...
var MeManiPlateComponent = /** @class */ (function () {
    ...
    MeManiPlateComponent.prototype.onPointLeave = function (e) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(1).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["delay"])(100)).toPromise()];
                    case 1:
                        _a.sent(); // for document.activeElement works correctly.
                        if (!(document.activeElement.localName !== "textarea" && this.isSubtitleClicked === false)) return [3 /*break*/, 3];
...
var PlayerComponent = /** @class */ (function () {
    ...
    PlayerComponent.prototype.eventListeners = function () {
        ...
        self.meService.requestMediaReady$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["takeUntil"])(self.unSubscribed))
            .subscribe(function (_) {
            var isReady = false;
            if (self.meService.story.meType === _vm_player_type_enum__WEBPACK_IMPORTED_MODULE_6__["PlayerType"].youtubeID && !!self.YTservice.ytPlayer === true) {
...
var FsService = /** @class */ (function () {
    ...
    FsService.prototype.saveTxtFile$$ = function (data, fileName) {
        return __awaiter(this, void 0, void 0, function () {
            var self, savePicker, iDot, ext, winFile, status_1, permissions_1, action, downloadDir, fileEntry, blob, isDone, cacheDir, isSaved, fileEntry_1, blob, action, result, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        self = this;
                    ...
                    case 17:
                        if (!(cordova.platformId === 'ios')) return [3 /*break*/, 26];
                        return [4 /*yield*/, self.getDir$('', false, false, cordova.file.cacheDirectory).toPromise()];
                    case 18:
                        cacheDir = _a.sent();
                        isSaved = false;
                        if (!!!cacheDir) return [3 /*break*/, 21];
                        return [4 /*yield*/, self.getFile$(fileName, true, false, cacheDir).toPromise()];
                    case 19:
                        fileEntry_1 = _a.sent();
                        blob = new Blob([data], { type: 'text/plain' });
                        return [4 /*yield*/, self.writeFile$(fileEntry_1, blob).toPromise()];
                    case 20:
                        isSaved = _a.sent();
                        if (isSaved) {
                            self.msgService.alert(((!!self.pts.pts) ? self.pts.pts.fsService.fileSaved :
                    ...
                    case 21:
                        ...
                        action = new Promise(function (res, rej) {
                            ...
                            cordova.plugins['fileOpener2'].showOpenWithDialog(fPath, 'text/plain', { error: rej, success: res });
                        });
                        console.log('before sharing: file path: ' + fileEntry_1.toURL());
                        _a.label = 22;
                    case 22:
                    ...
                    case 24:
                        error_1 = _a.sent();
                        console.log('I cannot open this file: ' + error_1.status + ': ' + error_1.message);
                        return [3 /*break*/, 25];
                    case 25:
...
var MediaEditService = /** @class */ (function () {
    function MediaEditService(adService, fsService, msgService, db, ptsService) {
        ...
        this.db = db;
        this.ptsService = ptsService;
        this.requestMediaReady$ = new rxjs__WEBPACK_IMPORTED_MODULE_1__["Subject"](); // Subscribed by player
        this.responseMediaReady$ = new rxjs__WEBPACK_IMPORTED_MODULE_1__["Subject"](); // emmited by player
        ...
        this.lastTimeCallInitMeFromUrl = 0;
        var self = this;
   ...
   */
    ...
    MediaEditService.prototype.canGetCurrentTime$$ = function () {
        return __awaiter(this, void 0, void 0, function () {
            var self;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, self.responseMediaReady$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["first"])()).toPromise()];
